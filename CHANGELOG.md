...
## [1.139.0](https://github.com/tonggaret/metacubexd/compare/v1.138.1...v1.139.0) (2024-05-10)


### Features

* add a close button to the modal ([#239](https://github.com/tonggaret/metacubexd/issues/239)) ([737f1b0](https://github.com/tonggaret/metacubexd/commit/737f1b018975f3e13a566c0dd744e1d1f545421f))
* add allow-lan ([#478](https://github.com/tonggaret/metacubexd/issues/478)) ([aa4d1d9](https://github.com/tonggaret/metacubexd/commit/aa4d1d9e517ed6f33920f0082fc3ade23236097d))
* add support for IPv6 check ([#403](https://github.com/tonggaret/metacubexd/issues/403)) ([4d5543c](https://github.com/tonggaret/metacubexd/commit/4d5543c64b32263ef1288aac19d3d749abddb59b))
* bump version ([66d92a9](https://github.com/tonggaret/metacubexd/commit/66d92a9b529504e2edbfd087a7d6783b8f257354))
* bun -&gt; pnpm ([74ed544](https://github.com/tonggaret/metacubexd/commit/74ed5448f4aca701f7e0e5f3013485ba449171b7))
* **button:** icon button ([5ef8410](https://github.com/tonggaret/metacubexd/commit/5ef8410da5cbc67ad7fc6bd63775e325aaf57828))
* **config:** display currently selected endpoint url ([59e0b07](https://github.com/tonggaret/metacubexd/commit/59e0b076bf42db40c2ff1bafa2ba126f79997d25))
* **config:** i18n support for port numbers ([07d3e7f](https://github.com/tonggaret/metacubexd/commit/07d3e7fdce396fcdfb5740d943fa16c0187f4b63))
* **config:** move switch language button into header ([9cc99eb](https://github.com/tonggaret/metacubexd/commit/9cc99ebb8e380f9b5e855b6d3250dfe96e237134))
* **config:** new version update available indicator ([857d0c5](https://github.com/tonggaret/metacubexd/commit/857d0c5387e9a19c6ca27d408461f10aa8b6ef9e))
* **config:** reload config file, flush fake-ip data ([6ffd1a8](https://github.com/tonggaret/metacubexd/commit/6ffd1a860538f82ef92e2fb97ed19d67e4452ad7))
* **config:** render versions in two grid columns ([64f2d71](https://github.com/tonggaret/metacubexd/commit/64f2d7139a036ec4abcd56baab6d0ca0429ecd39))
* **config:** select tunnel mode ([34ea1f1](https://github.com/tonggaret/metacubexd/commit/34ea1f1c5657d466c360b1b1771571b06f67e423))
* **config:** support tun related configurations ([512accd](https://github.com/tonggaret/metacubexd/commit/512accd4257a8f11cd412fb78224eb0b7c832f3e))
* **config:** three columns on small screen device, five on larger ([f4e82e0](https://github.com/tonggaret/metacubexd/commit/f4e82e0e270ff1cc6ec5ad0cec04cda807febcfa))
* **config:** toast error message when dns query failed for some reason, closes [#321](https://github.com/tonggaret/metacubexd/issues/321) ([82c2772](https://github.com/tonggaret/metacubexd/commit/82c2772afe913039b0695ef449f9f48b54eb822b))
* **config:** tun mode stack: `Mixed`, closes [#431](https://github.com/tonggaret/metacubexd/issues/431) ([59d7b04](https://github.com/tonggaret/metacubexd/commit/59d7b04d5ce5431c4b165c1d781be32eaa9cc4ff))
* **config:** update config page buttons layout, closes [#263](https://github.com/tonggaret/metacubexd/issues/263) ([dd0452d](https://github.com/tonggaret/metacubexd/commit/dd0452dcd3f68bad959f756cf191ea1c2470b2c1))
* **config:** update page layout ([95200a5](https://github.com/tonggaret/metacubexd/commit/95200a56b8902e443f5e8d2c8fa38ff6c6e28c2a))
* **config:** update page layout ([2be357e](https://github.com/tonggaret/metacubexd/commit/2be357e73c51c52709fe8b911b9e595ed281a7fa))
* **config:** update page layout, limit the max width of the container ([d059ea8](https://github.com/tonggaret/metacubexd/commit/d059ea85b3efd8c25e1ebed158b556df7eb2b5ae))
* **connection:** add sniffHost support, [#246](https://github.com/tonggaret/metacubexd/issues/246) ([2b16de1](https://github.com/tonggaret/metacubexd/commit/2b16de18b0bad7886baabe34ee7769c3e33bfff8))
* **connection:** drag handle, closes [#320](https://github.com/tonggaret/metacubexd/issues/320) ([dc8fddb](https://github.com/tonggaret/metacubexd/commit/dc8fddb08a2ba8fb9fdfa1629379eec552702b49))
* **connection:** filter client sourceIP with tag name support, closes [#264](https://github.com/tonggaret/metacubexd/issues/264) ([8df4d7a](https://github.com/tonggaret/metacubexd/commit/8df4d7a7e93570c9d4d76b5903907e1bcb2ab45a))
* **connection:** filter connections with sourceIP, closes [#246](https://github.com/tonggaret/metacubexd/issues/246) ([ffa2447](https://github.com/tonggaret/metacubexd/commit/ffa244760f639309c64f0a41b721921a4b57e558))
* **connections:** close filtered connections ([4f8c4b2](https://github.com/tonggaret/metacubexd/commit/4f8c4b2d15fdee6a546f0290b9c42c860aa334fb))
* **connections:** fuzzy filter ([9a144e8](https://github.com/tonggaret/metacubexd/commit/9a144e882dc7b33fd6a6e055b122533941a0361f))
* **connections:** keyed connection rows and cells ([e7eb3dd](https://github.com/tonggaret/metacubexd/commit/e7eb3dd331e0059ccf366f1411a1be208fec2a2a))
* **connections:** set CONNECTIONS_TABLE_MAX_CLOSED_ROWS to 200 ([b34ceb3](https://github.com/tonggaret/metacubexd/commit/b34ceb334d1b0df41d720ea471c9af7b694ae202))
* **connections:** shorten the tab names ([1a37a10](https://github.com/tonggaret/metacubexd/commit/1a37a106f8c421829854ffcb75b64b7885b00005))
* **connections:** tag client source ip with name, closes [#181](https://github.com/tonggaret/metacubexd/issues/181) ([e538f9d](https://github.com/tonggaret/metacubexd/commit/e538f9d057570871cac0ac94aeae9b40c99d0217))
* **connections:** use Index instead of key ([07f461f](https://github.com/tonggaret/metacubexd/commit/07f461f1105f3bbb1322ea4d246227a313ce02a4))
* **connection:** update tag badges layout ([b7a0407](https://github.com/tonggaret/metacubexd/commit/b7a0407e42b4433766bda53c4dd7866dfe7c1cb3))
* **connection:** 添加入站用户列 ([#437](https://github.com/tonggaret/metacubexd/issues/437)) ([1ba7700](https://github.com/tonggaret/metacubexd/commit/1ba7700a3f7f72e0b778a1b4af083231e1d6790c))
* display current selected endpoint at the bottom of the overview page ([3e92373](https://github.com/tonggaret/metacubexd/commit/3e92373166620dc52cbd8cdf5bfedc88296edf6e))
* drop ForTwoColumns renderer ([353b5eb](https://github.com/tonggaret/metacubexd/commit/353b5ebff3457c4a804836ee1428efeb7f8ad633))
* get package.json version from npm builtin environment variable ([0cdf390](https://github.com/tonggaret/metacubexd/commit/0cdf390c2801f2b8dc4678898a709143204ccf30))
* **i18n:** new language switcher in config page ([21d479a](https://github.com/tonggaret/metacubexd/commit/21d479a1df14c5fa0947e1824c7ce77609180d69))
* **LogoText:** update logo navigation links ([d7e8c2f](https://github.com/tonggaret/metacubexd/commit/d7e8c2f4a43f8805681de725208036fdd0150496))
* **logs:** fuzzy filter, sorting ([67345cf](https://github.com/tonggaret/metacubexd/commit/67345cf1e34eb309fa0a1ba5eb1bbfe441fc61fd))
* **logs:** use Index instead of For ([669492f](https://github.com/tonggaret/metacubexd/commit/669492f22c2d72ab9c6c18d1630bd0179f0f933b))
* minor improvements ([f4788bb](https://github.com/tonggaret/metacubexd/commit/f4788bb4634d73bac8ad0030849b0f60f971a610))
* **modal:** adjust padding of the modal header and footer ([53ee2f3](https://github.com/tonggaret/metacubexd/commit/53ee2f31b397b3abd6a208a88492be2f6eaaeebe))
* **modals:** add modal component ([#268](https://github.com/tonggaret/metacubexd/issues/268)) ([eca9a16](https://github.com/tonggaret/metacubexd/commit/eca9a160cc1db5558eb1a7ed14c9e544295ca7b4))
* new themes ([677d024](https://github.com/tonggaret/metacubexd/commit/677d024e988d67076f5a7bd4c716021a83bb3681))
* overscroll-y-none ([063cb31](https://github.com/tonggaret/metacubexd/commit/063cb31f151e56c6caa46f868bf861fe5748b4c6))
* proxy group is always placed at the forefront when sorting proxies ([#458](https://github.com/tonggaret/metacubexd/issues/458)) ([a0f80aa](https://github.com/tonggaret/metacubexd/commit/a0f80aa62dc4ed90fed288019fc00ec26b952316))
* **proxy:** add back the render proxies in two columns option, closes [#360](https://github.com/tonggaret/metacubexd/issues/360) ([62c0cd9](https://github.com/tonggaret/metacubexd/commit/62c0cd9a634f768a970afc66e15968f5f8821c5a))
* **proxy:** compact proxy node card ([40f07b8](https://github.com/tonggaret/metacubexd/commit/40f07b8efe7b6d48da0da5db1ce1372d07a14d3c))
* **proxy:** do not truncate the proxy node name when not enough width, closes [#351](https://github.com/tonggaret/metacubexd/issues/351) ([a648f1e](https://github.com/tonggaret/metacubexd/commit/a648f1e41399327341ca2e603b2331f5f42f9ccc))
* **proxy:** fetch proxies after latency test ([2a0b21b](https://github.com/tonggaret/metacubexd/commit/2a0b21bcc7bd0b096e1bc8008fef3ccf1649496a))
* **proxy:** hideUnAvailableProxies, closes [#200](https://github.com/tonggaret/metacubexd/issues/200) ([9e556d9](https://github.com/tonggaret/metacubexd/commit/9e556d959eb6ad801be30570118c942d9c31dc03))
* **proxy:** regression on render proxies in two columns ([8502a6e](https://github.com/tonggaret/metacubexd/commit/8502a6e4896e7a1c5e2049fcd2521a5434fcf70e))
* **proxy:** remove collapse component overflow-visible class ([389af52](https://github.com/tonggaret/metacubexd/commit/389af52c74e249fac957addd43eeeb8976957022))
* **proxy:** shorten the autoCloseConns i18n text ([2ee48c8](https://github.com/tonggaret/metacubexd/commit/2ee48c8ac90c79844254ff07a98fe48b50ca68c0))
* **proxy:** show more proxy nodes on larger screen ([5277c7b](https://github.com/tonggaret/metacubexd/commit/5277c7bbc99f7407ef195b8c2508332efbc59a07))
* **proxy:** single proxy node latency test ([9255658](https://github.com/tonggaret/metacubexd/commit/9255658e5408b0c48e1f35bdaf8fecf407bba869))
* **proxy:** single proxy node latency testing state indicator ([0052ce4](https://github.com/tonggaret/metacubexd/commit/0052ce4325fec2d185df98ad187efa70171d0a28))
* publish compressed dist with tar gzip format ([0c9b31d](https://github.com/tonggaret/metacubexd/commit/0c9b31d03f9d6670e1fabbeee4e3791a2d17a775))
* publish gh-pages with force_orphan option enabled ([067bedd](https://github.com/tonggaret/metacubexd/commit/067bedd43f9f75310335bc3b97f003ca06ea4d38))
* publish gh-pages with tag name as commit message ([336b954](https://github.com/tonggaret/metacubexd/commit/336b9545e662b78f5234d5dfcf926e017857c643))
* **pwa:** add pwa shortcut icon, closes [#201](https://github.com/tonggaret/metacubexd/issues/201) ([3a23e99](https://github.com/tonggaret/metacubexd/commit/3a23e99c269373bbbaae95cdca65d7a0dbdddc10))
* release ([da417aa](https://github.com/tonggaret/metacubexd/commit/da417aa5745e12771aa7df2999e7ea90a8b27932))
* **rule:** filter rules and rule providers by search input ([db16200](https://github.com/tonggaret/metacubexd/commit/db16200b1ce42f31a813a41b6c3eedbab63baeac))
* **rule:** fuzzy filter ([f53a1a4](https://github.com/tonggaret/metacubexd/commit/f53a1a4cb34211d1a9b6c14ed7938702d194eb1d))
* **rule:** implement virtual scroll on rules and rule providers, fixes [#285](https://github.com/tonggaret/metacubexd/issues/285) ([7145cec](https://github.com/tonggaret/metacubexd/commit/7145cec62fd4fc409d3f0e46f7aaaf0bea354abd))
* **rules:** renderInTwoColumns ([6743ebd](https://github.com/tonggaret/metacubexd/commit/6743ebde8f5e13f32b27f913c620629517f63da2))
* settings per-page ([d776260](https://github.com/tonggaret/metacubexd/commit/d77626058af9a3d22f22e410918d2aafb3f2ea46))
* show provider expire message with i18n ([#237](https://github.com/tonggaret/metacubexd/issues/237)) ([b9e9a95](https://github.com/tonggaret/metacubexd/commit/b9e9a955f26e1ebf9f45fd951fbbfe295f487c85))
* **theme:** update default theme ([be0bc55](https://github.com/tonggaret/metacubexd/commit/be0bc55317006725c0a155162a2b604a888b6847))
* update backend repository url ([43acdac](https://github.com/tonggaret/metacubexd/commit/43acdace5dbcf39ea736a9d6f1ee8078a19a1647))
* upgrade dependencies ([e8348d8](https://github.com/tonggaret/metacubexd/commit/e8348d8675075698d81f51d0333d008aa8107cc9))


### Bug Fixes

* `//` in websocketpath ([#651](https://github.com/tonggaret/metacubexd/issues/651)) ([ed70948](https://github.com/tonggaret/metacubexd/commit/ed70948a364279f7f9acffb903f6e46a94191da6))
* closes [#685](https://github.com/tonggaret/metacubexd/issues/685) ([995388f](https://github.com/tonggaret/metacubexd/commit/995388f74fcdb54007a8e595334b6e0a2910a91c))
* **config:** backend version is likely to be undefined when invoking isUpdateAvailableAPI ([398f05d](https://github.com/tonggaret/metacubexd/commit/398f05d8a54cf85964024e05e01c56d2fb99714d))
* **config:** the bottom edge of the page gets cutoff, closes [#385](https://github.com/tonggaret/metacubexd/issues/385) ([522be60](https://github.com/tonggaret/metacubexd/commit/522be608a70d142e0805f14748c073c476d5f713))
* **connection:** cannot filter by undefined ([08776a5](https://github.com/tonggaret/metacubexd/commit/08776a5bee855d3d7d7fa32b1ca43b41272ce988))
* **connection:** limit the max width of client source ip select, closes [#270](https://github.com/tonggaret/metacubexd/issues/270) ([ca1e3ce](https://github.com/tonggaret/metacubexd/commit/ca1e3ce82c7a200abb0dd2ac744827a57a410763))
* **Dockerfile:** lock node alpine version ([6f5c1da](https://github.com/tonggaret/metacubexd/commit/6f5c1dade011dc0359366b832bbb0879e079e99f))
* failed to resolve import solid-infinite-scroll ([ebc95fe](https://github.com/tonggaret/metacubexd/commit/ebc95fe58592a6f187f733ea1da3b56d738a7406))
* last delay fallback ([#468](https://github.com/tonggaret/metacubexd/issues/468)) ([0e3c465](https://github.com/tonggaret/metacubexd/commit/0e3c46569a327451e43542e0cedf83b9087b675b))
* **log:** log level value not selected ([3fbed0d](https://github.com/tonggaret/metacubexd/commit/3fbed0d69482da005bfa109eed9acae203a08ce2))
* logMaxRows value ([b3c924e](https://github.com/tonggaret/metacubexd/commit/b3c924e33bdca68fed59092c107cc38324a418d0))
* **logs:** inconsistent gap between search input and table ([477fb22](https://github.com/tonggaret/metacubexd/commit/477fb2233a56e5d3a015a27292580eac0267b7d8))
* **logs:** inconsistent padding ([3076487](https://github.com/tonggaret/metacubexd/commit/30764873a834f04dd7855a69b03cfb9c68f549fd))
* **modals:** close icon button style issue ([7f8d71c](https://github.com/tonggaret/metacubexd/commit/7f8d71ccc5b847ddb39e332199e21ede43483ea6))
* **overview:** error when reading length ([#188](https://github.com/tonggaret/metacubexd/issues/188)) ([9f227c9](https://github.com/tonggaret/metacubexd/commit/9f227c9c2c38718bf540bb5c9c5959a647d00af2))
* protected pages behind selected endpoint, fixes [#647](https://github.com/tonggaret/metacubexd/issues/647) ([a387722](https://github.com/tonggaret/metacubexd/commit/a3877229b8807f1c9f1b68f31dc348f061f3e24e))
* **proxies:** format proxy type ([1c61df8](https://github.com/tonggaret/metacubexd/commit/1c61df8b8b39fd587393bdaf8ee52c2da12e89ad))
* proxy providers grid layout ([6d242a4](https://github.com/tonggaret/metacubexd/commit/6d242a44579522c65e086a5c5c89824329643c0b))
* **proxy:** dont hideUnAvailableProxies in proxy providers ([be6edd9](https://github.com/tonggaret/metacubexd/commit/be6edd914a32b05125337fd113d571f6066b0265))
* **proxy:** fetch proxies after latency test ([81fe550](https://github.com/tonggaret/metacubexd/commit/81fe55091292015b623e2545fd7d0547cfffbed0))
* **proxy:** proxy node card layout issue, closes [#429](https://github.com/tonggaret/metacubexd/issues/429) ([88bfcf8](https://github.com/tonggaret/metacubexd/commit/88bfcf8d731e0d2c57f31d2ba2af2d603c66bf16))
* **proxy:** proxy preview bar style issue ([54226bc](https://github.com/tonggaret/metacubexd/commit/54226bcdc4b205dffad5d4b9358ebc42525b1f31))
* **proxy:** proxy preview dots layout issue ([4b7f4c8](https://github.com/tonggaret/metacubexd/commit/4b7f4c899f4549ffc89d84a0a93f5f837918fdb3))
* **proxy:** proxy provider health check not working, closes [#282](https://github.com/tonggaret/metacubexd/issues/282) ([db24ad2](https://github.com/tonggaret/metacubexd/commit/db24ad20bb5fbfcf195dc4c71f3024091bf16f1b))
* **proxy:** selectProxyInGroup ([dc0b286](https://github.com/tonggaret/metacubexd/commit/dc0b286a888085352be54de1dda50962330318cf))
* **proxy:** tabs won't be shown in proxies page when proxy provider list is empty ([6c5662a](https://github.com/tonggaret/metacubexd/commit/6c5662a7a9a99ccd6b6d570a8da983fa37effc0b))
* **proxy:** wrap subscription info usage percentage with toFinite ([ed947f6](https://github.com/tonggaret/metacubexd/commit/ed947f62a26c30a6f30aaf73066d7aea6f520bb0))
* **rule:** rule pages filter logic is not stable, fixes [#313](https://github.com/tonggaret/metacubexd/issues/313) ([1f22147](https://github.com/tonggaret/metacubexd/commit/1f22147cd14462e11b82cd367cbf7b786358d6e5))
* **rules:** reload button style issue ([04c8d25](https://github.com/tonggaret/metacubexd/commit/04c8d2524b6d6b0fb1b2f36b98a0ffe2a20fbf8c))
* **setup:** setup with url search string not working properly ([ce4622b](https://github.com/tonggaret/metacubexd/commit/ce4622b9543d14b304bf10bcc2d542ee248a14bc))
* **setup:** use location info from router instead of browser ([7ecc51c](https://github.com/tonggaret/metacubexd/commit/7ecc51c43c581105506f23192f4d7b6938ec944c))
* subscriptionInfo may not be valid ([e7ba6c7](https://github.com/tonggaret/metacubexd/commit/e7ba6c7c34ceae395cd59337d965ee74b672e799))
* time from now date string not following locale changes ([ba21999](https://github.com/tonggaret/metacubexd/commit/ba21999ed17cdf8997207ac7727525ba07ce0676))
* version not showing ([0f0b771](https://github.com/tonggaret/metacubexd/commit/0f0b771f218b203bb37bb9d5432d462eb73b6192))
* virtual scroll ([73fb1a7](https://github.com/tonggaret/metacubexd/commit/73fb1a7ed49ef6dfc72198cf271526a04f023247))


### Performance Improvements

* batch signals ([0015468](https://github.com/tonggaret/metacubexd/commit/0015468077c146e1d7526863873b3af16f01fccc))
* batch signals ([e04ec71](https://github.com/tonggaret/metacubexd/commit/e04ec712ea5582d32dc723cc1ebcef4d192ab185))
* **overview:** shrink the data size every minute, closes [#234](https://github.com/tonggaret/metacubexd/issues/234) ([e0766fc](https://github.com/tonggaret/metacubexd/commit/e0766fc2c829b51728e16a587b68d13bd34c3bd9))
